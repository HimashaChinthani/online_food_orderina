...
import com.himasha.repository.CartItemRepository;
...
@Service
@Data
public class  CartServiceImp implements CartService { // Removed 'abstract'
    ...
    public CartItem addItemToCart(AddCartItemRequest req, String jwt) throws Exception {
        ...
        if (req.getFoodId() == null) {
            throw new IllegalArgumentException("Food ID cannot be null");
        }
    ...
    public Cart removeItemFromCart(Long cartItemId, String jwt) throws Exception {
        ...
        CartItem item = cartItemOptional.get();
        cart.getItems().remove(item); // Corrected 'cart.getItem()' to 'cart.getItems()'
